...
| 🔍 Сравнение версий дизайна вручную | 🔀 **Визуальный diff со стрелками перемещения** |

---

## 🌟 Что нового в v3.6.0

### 🔀 Сравнение версий проектов (НОВОЕ!)

**Киллер-фича для ревью Wi-Fi дизайна!** Сравните любые две версии проекта:

- **Визуальные диффы планов этажей** - Цветовые маркеры со стрелками перемещения
- **Точные расстояния в метрах** - Используется масштаб проекта, не пиксели
- **Полное отслеживание изменений** - Добавленные, удалённые, изменённые, перемещённые, переименованные AP
- **Детальные изменения полей** - TX мощность, канал, азимут и другие
- **Экспорт отчётов** - CSV, HTML, JSON для документации

![Пример визуального диффа](docs/examples/comparison_output/diff_maga-flat.png)

*Пример: 3 AP перемещены (синие→фиолетовые стрелки показывают перемещение на 1.4м, 2.0м, 3.1м)*
...
**Web UI:** Авто-сравнение при обновлении проекта с отдельной вкладкой Comparison

📖 [Полная документация](docs/PROJECT_COMPARISON.ru.md) | [Примеры вывода](docs/examples/comparison_output/)

---

### 🐳 Docker контейнеризация (v3.5.0)
...
### 🔐 OAuth2/SSO аутентификация (v3.5.0)

- Keycloak, Azure AD, Okta, Google Workspace
- Единый вход (SSO)
- Ролевой доступ

### 📱 Мобильный интерфейс (v3.5.0)

- Адаптивное hamburger-меню
- Карточный вид на мобильных
- Touch-friendly элементы

### 🤖 Автоматизация (v3.4.0)

**Планировщик пакетной обработки** с уведомлениями:
- 📧 Email отчёты
- 💬 Уведомления в Slack
