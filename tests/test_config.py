...
class TestConfigLoading:
    ...
    def test_load_valid_config(self):
        ...
        config_data = {
            "export": {"formats": ["csv", "excel"], "output_dir": "reports"},
            "pricing": {"enabled": True, "default_discount": 10.0},
        }
...
class TestConfigGet:
    ...
    def test_get_nested_key(self):
        ...
        config = Config({"export": {"formats": ["csv"], "output_dir": "output"}})
...
class TestConfigMergeWithArgs:
    ...
    def test_cli_overrides_config(self):
        ...
        config = Config({"export": {"output_dir": "config_output", "formats": ["csv"]}})
    ...
    def test_config_defaults_when_no_cli(self):
        ...
        config = Config(
            {
                "export": {"output_dir": "config_output", "formats": ["excel", "html"]},
                "pricing": {"enabled": True, "default_discount": 15.0},
            }
        )
...
class TestConfigValidationExtended:
    ...
    def test_validate_formats_not_list(self):
        ...
        config_data = {"export": {"formats": "csv"}}  # Should be a list, not a string
    ...
    def test_validate_pdf_paper_size(self):
        ...
        # Valid paper size
        config_data = {"pdf": {"paper_size": "A4"}}
        config = Config(config_data)
        config._validate()  # Should not raise

        # Invalid paper size
        config_data_invalid = {"pdf": {"paper_size": "B5"}}  # Not in valid sizes
    ...
    def test_validate_pdf_orientation(self):
        ...
        # Valid orientation
        config_data = {"pdf": {"orientation": "landscape"}}
        config = Config(config_data)
        config._validate()  # Should not raise
    ...
    def test_validate_pdf_all_settings(self):
        ...
        config_data = {"pdf": {"paper_size": "Letter", "orientation": "portrait"}}
        config = Config(config_data)
    ...
    def test_merge_with_colors_database_in_config(self):
        ...
        config = Config({"colors": {"database": "config_colors.csv"}})
    ...
    def test_merge_with_pricing_database_in_config(self):
        ...
        config = Config({"pricing": {"database": "config_pricing.csv"}})
    ...
    def test_to_dict(self):
        ...
        config = Config({"export": {"output_dir": "output", "formats": ["csv"]}})
