...
class FloorPlanVisualizer:
    ...
    def __init__(
        ...
        Args:
            ...
            ap_opacity: Opacity for AP markers (0.0-1.0, default: 1.0 = 100%)
        """
    ...
    def visualize_floor(
        ...
        for ap in floor_aps:
            ...
            if ap.color:
                ...
                fill_color = (173, 216, 230, opacity_value)  # Light blue with configured opacity
        ...
        for arrow_data in arrows_to_draw:
            ...
            if mounting_type == "WALL":
                ...
                arrow_length = self.ap_circle_radius * 2
            else:
