        ...
        json_structure = {
            ...
            "analytics": {
                ...
                "radio": {
                    ...
                    "wifi_standards": (
                        radio_metrics.standard_distribution if radio_metrics else {}
                    ),
                    "tx_power": (
                        {
                ...
                "cable_infrastructure": (
                    {
                        "metrics": {
                            ...
                            "avg_length_units": (
                                cable_metrics.avg_length if cable_metrics else 0.0
                            ),
                            "min_length_units": (
                                cable_metrics.min_length if cable_metrics else 0.0
                            ),
                            "max_length_units": (
                                cable_metrics.max_length if cable_metrics else 0.0
                            ),
                            "cables_by_floor": (
